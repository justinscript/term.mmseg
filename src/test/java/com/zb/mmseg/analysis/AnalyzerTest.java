...
public class AnalyzerTest {
    ...
    public void testComplex() {
        ...
        try {
            ...
            /*
             * txt = "第一卷 云天落日圆 第一节 偷欢不成倒大霉"; txt = "中国人民银行"; txt = "我们"; txt = "工信处女干事每月经过下属科室都要亲口交代24口交换机等技术性器件的安装工作";
             */
    ...
    public void testCutLeeterDigitFilter() {
        String myTxt = "mb991ch cq40-519tx mmseg2j ";
        ...
        Assert.assertArrayEquals("CutLeeterDigitFilter fail", words.toArray(new String[words.size()]),
                                 "mb 991 ch cq 40 519 tx mmseg 2 j".split(" "));
    }
    ...
    private void printlnToken(String txt, Analyzer analyzer) throws IOException {
        ...
        /*
         * //lucene 2.9 以下 for(Token t= new Token(); (t=ts.next(t)) !=null;) { System.out.println(t); }
         */
        /*
         * while(ts.incrementToken()) { TermAttribute termAtt = (TermAttribute)ts.getAttribute(TermAttribute.class);
         * OffsetAttribute offsetAtt = (OffsetAttribute)ts.getAttribute(OffsetAttribute.class); TypeAttribute typeAtt =
         * (TypeAttribute)ts.getAttribute(TypeAttribute.class);
         * System.out.println("("+termAtt.term()+","+offsetAtt.startOffset
         * ()+","+offsetAtt.endOffset()+",type="+typeAtt.type()+")"); }
         */
