...
public class CutLetterDigitFilter extends TokenFilter {
    ...
    private Token nextToken(Token reusableToken) throws IOException {
        ...
        /*
         * //在 TokenUtils.nextToken 已经调用了 inc if(!input.incrementToken()) { return null; }
         */
        ...
        if (nextToken != null
            && (MMSegWord.TYPE_LETTER_OR_DIGIT.equalsIgnoreCase(nextToken.type()) || MMSegWord.TYPE_DIGIT_OR_LETTER.equalsIgnoreCase(nextToken.type()))) {
